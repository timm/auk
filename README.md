...
- About [25 lines of runtime support](https://github.com/timm/auk/blob/master/auk.awk#L28-L52)
  code.

So yes, it is true, 
[a little auk (awk)](https://en.wikipedia.org/wiki/Little_auk)
goes a long  way](etc/img/littleaukhabitat.png).
